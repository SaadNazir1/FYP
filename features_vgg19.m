...
load('vggmodel_19.mat')
% plot(mobnet_Transfer)

vggmodel_19.Layers(1)
vggmodel_19.Layers(end)
% Number of class names for ImageNet classification task
imageSize = vggmodel_19.Layers(1).InputSize;
...
trainingFeatures = activations(vggmodel_19, augmentedTrainingSet, featureLayer, ...
...
testFeatures = activations(vggmodel_19, augmentedTestSet, featureLayer, ...
    'MiniBatchSize', 32, 'OutputAs', 'columns');
